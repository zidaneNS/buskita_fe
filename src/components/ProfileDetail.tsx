    ...
    return (
        <div className="flex flex-col w-full gap-y-3">
            ...
            <div className="px-2 md:px-4 py-1 md:py-2 bg-black/30 border border-dark-purple shadow-xl rounded-md w-full flex gap-x-3 items-center">
                <input className={`text-base md:text-lg outline-none rounded-md px-4 py-2 w-full ${isEditing && isChangeable ? "border border-white/30": "border-none"}`} value={content} onChange={(e) => handleInput(e)} readOnly={!isEditing} autoFocus={isEditing} />
