  ...
  return (
    <div className="w-full flex flex-col gap-y-4 md:gap-y-8">
      <div className="flex flex-col gap-y-1">
        <p className="text-2xl md:text-3xl font-semibold">Profile Information</p>
        <p className="text-slate-300">Manage Your User Profile</p>
      </div>
      <form action={action} className="grid grid-cols-1 md:grid-cols-2 gap-x-2 gap-y-4 w-full min-h-full">
        ...
        <ProfileDetail isEditing={isEditing} type="text" setIsEditing={setIsEditing} attribute="Validated" value="valid" />
